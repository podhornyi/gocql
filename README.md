...
![go build](https://github.com/podhornyi/gocql/actions/workflows/main.yml/badge.svg)
[![GoDoc](https://godoc.org/github.com/podhornyi/gocql?status.svg)](https://godoc.org/github.com/podhornyi/gocql)

Package gocql implements a fast and robust Cassandra client for the
Go programming language.

Project Website: https://gocql.github.io/<br>
API documentation: https://godoc.org/github.com/podhornyi/gocql<br>
...
------------
    ...
    go get github.com/podhornyi/gocql
...
See [package documentation](https://pkg.go.dev/github.com/podhornyi/gocql#pkg-examples).
